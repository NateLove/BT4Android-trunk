...
public class SettingsActivity extends Activity{
	...
	public void refreshTimes()
	{
		...
		int selected = 0;
		if(timesToShow == 1) selected = 0;
		if(timesToShow == 3) selected = 1;
		if(timesToShow == 5) selected = 2;
		if(timesToShow == 200) selected = 3;
	...
	public void refreshTabs()
	{
		...
		builder.setSingleChoiceItems(items, defaultTab,new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int item) {
